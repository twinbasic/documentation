...
![A form before and after resizing, where a TextBox anchored on all four sides grows in both directions](../Images/fddbffa9-2b71-47f5-b925-e67fc66b9e5c.png)
...
![A form before and after resizing, where a TextBox anchored top, left and bottom grows taller but not wider](../Images/3fa1cf2b-0af5-44ae-ae6a-3c0662f51f57.png)
...
![A form before and after resizing, where a TextBox anchored right and bottom keeps its size and moves with the corner](../Images/0aeb25f6-d864-4ebb-a9f5-bbd7b5d242e8.png)
...
![A form before and after resizing, where a TextBox anchored on all four sides inside a Frame anchored on all four sides grows with the Frame](../Images/4829696d-788b-40ee-bebd-5afa44477460.png)
...
![A form before and after resizing, where the Frame grows taller but the TextBox inside it keeps its height](../Images/bc9f3756-a14b-4ee7-b819-6822497b640a.png)
...
![A form with a Button docked to the bottom, spanning the full width below an undocked TextBox](../Images/599a66ad-31d5-449f-bbf5-00963fe9aa2a.png)
...
![A form with a TextBox and a Button both docked to the bottom, and above them a PictureBox holding a Button docked right with a TextBox filling the rest](../Images/80185a8d-2952-415f-bc02-ec3ddea89568.png)
