...
- [Alias Types](Alias-Types) - alias types, similar to **typedef** in C and **using** in C++
...
- [Literals](Literals) - Binary literals and digit grouping
- [Type Inference](Type-Inference) - **As Any** type inference
