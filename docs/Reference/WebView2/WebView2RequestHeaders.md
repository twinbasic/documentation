...
- As the **RequestHeaders** argument of the [**NavigationStarting**](WebView2/#navigationstarting) event — the headers that will be sent for the page navigation. Mutations made before the event handler returns are sent on the wire.
