...
All executable code must be in procedures. A **Sub** procedure cannot be defined inside another **[Sub](Sub)**, **[Function](Function)**, or **[Property](Property)** procedure.
...
A **Sub** procedure is called by using the procedure name followed by the argument list. See the **[Call](Call)** statement for specific information about how to call **Sub** procedures.
