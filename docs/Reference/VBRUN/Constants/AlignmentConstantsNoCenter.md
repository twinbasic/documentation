---
title: AlignmentConstantsNoCenter
parent: Constants Module
grand_parent: VBRUN Package
permalink: /tB/Packages/VBRUN/Constants/AlignmentConstantsNoCenter
---
...
|----------|-------|-------------|
| **tbLeftJustify**{: #tbLeftJustify } | 0 | Text is left-justified. |
| **tbRightJustify**{: #tbRightJustify } | 1 | Text is right-justified. |
