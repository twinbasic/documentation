---
title: ShortcutConstants
parent: Constants Module
grand_parent: VBRUN Modules
permalink: /tB/Packages/VBRUN/Constants/ShortcutConstants
---
# ShortcutConstants
{: .no_toc }
...
|----------|-------|-------------|
| **vbShortcutNone**{: #vbShortcutNone } | 0 | No shortcut is assigned. |
...
| Constant | Value | Description |
|----------|-------|-------------|
| **vbShortcutCtrlInsert**{: #vbShortcutCtrlInsert } | 71 | **Ctrl** + **Insert**. |
| **vbShortcutShiftInsert**{: #vbShortcutShiftInsert } | 72 | **Shift** + **Insert**. |
| **vbShortcutDelete**{: #vbShortcutDelete } | 73 | **Delete**. |
| **vbShortcutShiftDelete**{: #vbShortcutShiftDelete } | 74 | **Shift** + **Delete**. |
| **vbShortcutAltBackspace**{: #vbShortcutAltBackspace } | 75 | **Alt** + **Backspace**. |
