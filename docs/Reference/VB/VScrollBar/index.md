...
Both [**SmallChange**](#smallchange) and [**LargeChange**](#largechange) default to `1`. [**LargeChange**](#largechange) also drives the visible height of the thumb relative to the track, so larger values produce a chunkier thumb.
...
A read-only [**ControlTypeConstants**](../../VBRUN/Constants/ControlTypeConstants) value identifying this control as a vertical scroll bar. Always **vbVScrollBar**.
