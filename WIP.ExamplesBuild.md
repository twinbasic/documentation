...
**1,117 samples are marked today** and the gate over them takes ~110 s, in 41 projects. That
...
Of the 1,169 `tb` fences, 1,117 are marked and compile, 52 are `inert` with a recorded
