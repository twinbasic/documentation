...
This is the most interesting part for a CustomControl.  As such, it gets its own section, see [Painting / drawing to your control](CustomControls---Painting_drawing-to-your-control)
***
...
The passed in Serializer object offers a `Deserialize()` method that you call in order to load the properties that have been set for your control via the form designer.  See [Property Sheet and Object Serialization](CustomControls---Property-sheet-and-object-serialization) for further information.